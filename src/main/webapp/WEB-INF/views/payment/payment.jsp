...
<title>check</title>
<path
			d="M9 16.172l10.594-10.594 1.406 1.406-12 12-5.578-5.578 1.406-1.406z"></path>
</symbol>
...
<path
			d="M4 22h4v-2h-4v2zM10 22h4v-2h-4v2zM12 16h-8v2h8v-2zM8 14h2l4-4h-2l-4 4zM14 18h6v-2h-6v2zM30 6c-1 0-27 0-28 0s-2 1-2 2 0 15 0 16 1 2 2 2 27 0 28 0 2-1 2-2 0-15 0-16-1-2-2-2zM30 14v9s0 1-1 1h-26c-1 0-1-1-1-1v-9h2l4-4h-6v-1s0-1 1-1h26c1 0 1 1 1 1v1h-12l-4 4h16z"></path>
</symbol>
<symbol id="icon-lock" viewBox="0 0 24 24">
<title>lock</title>
<path
			d="M15.094 8.016v-2.016c0-1.688-1.406-3.094-3.094-3.094s-3.094 1.406-3.094 3.094v2.016h6.188zM12 17.016c1.078 0 2.016-0.938 2.016-2.016s-0.938-2.016-2.016-2.016-2.016 0.938-2.016 2.016 0.938 2.016 2.016 2.016zM18 8.016c1.078 0 2.016 0.891 2.016 1.969v10.031c0 1.078-0.938 1.969-2.016 1.969h-12c-1.078 0-2.016-0.891-2.016-1.969v-10.031c0-1.078 0.938-1.969 2.016-1.969h0.984v-2.016c0-2.766 2.25-5.016 5.016-5.016s5.016 2.25 5.016 5.016v2.016h0.984z"></path>
</symbol>
<symbol id="icon-info" viewBox="0 0 24 24">
<title>info</title>
<path
			d="M12.984 9v-2.016h-1.969v2.016h1.969zM12.984 17.016v-6h-1.969v6h1.969zM12 2.016c5.531 0 9.984 4.453 9.984 9.984s-4.453 9.984-9.984 9.984-9.984-4.453-9.984-9.984 4.453-9.984 9.984-9.984z"></path>
</symbol>
      ...
      <a href="#" class="path__item">5. Payment method</a>
			...
			<div class="pages">
				<div class="page page--1">
					...
					<p class="microcopy">Please tell us to which email address we
						can send the order confirmation.</p>

					<div class="f">
						<div class="input">
							<label for="email" class="input__label">Email <span
								class="required">(required)</span></label> <input id="email"
								type="email" class="input__input"
								data-mask=".+@\w+\.+\w+(\.+\w+)?" />
							<div class="input__error">Please enter a valid email
								address.</div>
						</div>

						<label for="newsletter" class="control"> <input
							type="checkbox" id="newsletter" class="control__input" />
							<div class="control__label">
								Please keep me informed about <b>offers</b> and <b>discounts</b>.
							</div>
						</label>
					</div>
					...
					<div class="f">
						<div class="input">
							<label for="name" class="input__label">Your full name <span
								class="required">(required)</span></label> <input id="name" type="text"
								class="input__input" />
						</div>
						<div class="f60">
							<div class="input">
								<label for="address" class="input__label">Address <span
									class="required">(required)</span></label> <input id="address"
									type="text" class="input__input" />
								<div class="input__error">Please enter a valid address.</div>
							</div>
						</div>
						<div class="f40">
							<div class="input">
								<label for="appartment" class="input__label">Apt.,
									suite, etc. <span class="optional">(optional)</span>
								</label> <input id="appartment" type="email" class="input__input" />
							</div>
						</div>
						<div class="collapser">
							<div class="collapser__label">
								<a href="#">Add another address line</a>
							</div>
							<div class="collapser__content">
								<div class="input">
									<label for="address2" class="input__label">Address <span
										class="optional">(optional)</span></label> <input id="address2"
										type="text" class="input__input" />
									<div class="input__error">Please enter a valid address.</div>
								</div>
							</div>
						...
						<!--             <div class="f40"> -->
						<div class="input">
							<label for="city" class="input__label">City <span
								class="required">(required)</span></label> <input id="city" type="text"
								class="input__input" />
						</div>
						<!--             </div> -->
						<div class="f35">
							<div class="input input--select">
								<label for="country" class="input__label">Country <span
									class="required">(required)</span></label> <select name="country"
									id="country" class="input__input">
						...
						<div class="f35">
							<div class="input input--select">
								<label for="province" class="input__label">Province <span
									class="required">(required)</span></label> <select name="province"
									id="province" class="input__input">
						...
						<div class="f30">
							<div class="input">
								<label for="postalcode" class="input__label">Postal code
									<span class="required">(required)</span>
								</label> <input id="postalcode" type="text" class="input__input"
									data-mask="^\w{1}\d{1}\w{1}\s*\d{1}\w{1}\d{1}$" />
								<div class="input__error">Please enter a valid postal
									code.</div>
							</div>
						</div>
					</div>
					...
					<div class="f">
						<label for="billing-same" class="control"> <input
							type="checkbox" id="billing-same" class="control__input" checked />
							<div class="control__label">
								My <b>billing information</b> is the same as my <b>shipping
									information</b>.
							</div>
						</label>
					</div>
					...
					<div id="billing">
						...
						<p class="microcopy">The person that will be billed for this
							order, if different from the shipping receiver.</p>

						<div class="f">
							<div class="input">
								<label for="billing-name" class="input__label">Full name
									<span class="required">(required)</span>
								</label> <input id="billing-name" type="text" class="input__input" />
							</div>
							<div class="f60">
								<div class="input">
									<label for="billing-address" class="input__label">Address
										<span class="required">(required)</span>
									</label> <input id="billing-address" type="text" class="input__input" />
									<div class="input__error">Please enter a valid address.</div>
								</div>
							</div>
							<div class="f40">
								<div class="input">
									<label for="billing-appartment" class="input__label">Apt.,
										suite, etc. <span class="optional">(optional)</span>
									</label> <input id="billing-appartment" type="email"
										class="input__input" />
								</div>
							</div>
							<div class="input">
								<label for="billing-city" class="input__label">City <span
									class="required">(required)</span></label> <input id="billing-city"
									type="text" class="input__input" />
							</div>
							<div class="f35">
								<div class="input input--select">
									<label for="billing-country" class="input__label">Country
										<span class="required">(required)</span>
									</label> <select name="billing-country" id="billing-country"
										class="input__input">
										<option disabled>Country</option>
										<option value="US">United States</option>
										<option value="CA" selected>Canada</option>
							...
							<div class="f35">
								<div class="input input--select">
									<label for="billing-province" class="input__label">Province
										<span class="required">(required)</span>
									</label> <select name="billing-province" id="billing-province"
										class="input__input">
										<option disabled>Province</option>
										<option value="AB">Alberta</option>
										<option value="ON" selected>Ontario</option>
							...
							<div class="f30">
								<div class="input">
									<label for="billing-postalcode" class="input__label">Postal
										code <span class="required">(required)</span>
									</label> <input id="billing-postalcode" type="text"
										class="input__input"
										data-mask="^\w{1}\d{1}\w{1}\s*\d{1}\w{1}\d{1}$" />
									<div class="input__error">Please enter a valid postal
										code.</div>
				...
				<div class="page page--2">
					...
					<p class="microcopy">Select the shipping method you would like
						to use.</p>

					<div class="f f--no-margin">
						<label for="shipping-free" class="control block is-selected">
							<input type="radio" name="shipping" id="shipping-free"
							class="control__input" checked />
							<div class="control__label">
								Free shipping
								<div class="microcopy">
									Get my order delivered by <span class="secondary">September
										21st</span>.
								</div>
							</div> <span class="control__extra primary">FREE</span>
						</label> <label for="shipping-standard" class="control block"> <input
							type="radio" name="shipping" id="shipping-standard"
							...
							</div> <span class="control__extra">$14.00</span>
						</label> <label for="shipping-rush" class="control block"> <input
							type="radio" name="shipping" id="shipping-rush"
							class="control__input" />
							<div class="control__label">
								Rush shipping
								<div class="microcopy">
							...
							</div> <span class="control__extra">$39.00</span>
						</label>
					</div>
					...
					<div class="form__footer">
						...
						<button class="btn btn--transparent secondary js-goto"
							data-page="1">
							<svg class="btn__icon">
								<use xlink:href="#icon-navigate_before"></use></svg>
				...
				<div class="page page--3 is-active">
					...
					<p class="microcopy">Select the payment method you would like
						to use.</p>

					<div class="f f--no-margin">
						<label for="payment-cc" class="control block is-selected">
							<input type="radio" name="payment" id="payment-cc"
							class="control__input" checked />
							<div class="control__label">
								무통장입금
								<!-- <div class="microcopy">Pay safely and securely with your credit card.</div> -->
							</div> <!-- <span class="control__extra">
                ...
                <svg class="control__icon"><use xlink:href="#icon-credit-card"></use></svg>
						...
						<div class="block block--collapse">
							<div class="f">
								<div class="input is-selected">
									...
									<label for="ccnumber" class="input__label">입금자명 <!-- <span class="required">(required)</span> -->
									</label>
									...
									<input id="ccsecurity" type="text" class="input__input"
										data-mask="^\d{3,4}$" />
									<!-- <div class="input__error">입금자명을 입력해주세요</div> -->
								</div>
								<div class="f30">
									<div class="input input--select">
										<label for="ccmonth" class="input__label">입금은행 <!-- <span class="required">(required)</span> -->
										</label> <select name="ccmonth" id="ccmonth" class="input__input">
                  ...
                  <div class="input">
                    ...
                    <div class="input__error">Please enter a security code.</div>
						...
						<label for="payment-paypal" class="control block"> <input
							type="radio" name="payment" id="payment-paypal"
							class="control__input" />
							<div class="control__label">
								신용/체크카드
								<div class="microcopy">credit / check card</div>
							</div> <span class="control__extra"> <svg class="control__icon">
									<use xlink:href="#icon-credit-card"></use></svg> <!-- <svg class="control__icon"><use xlink:href="#icon-credit-card"></use></svg>
                <svg class="control__icon"><use xlink:href="#icon-credit-card"></use></svg>
                <svg class="control__icon"><use xlink:href="#icon-credit-card"></use></svg> -->
						</span>
						</label>
                ...
                <h2>Gift cards</h2>
							...
							<p class="microcopy">Add gifts cards you would like to
								redeem.</p>
							...
							<div class="f">
								<div class="f70">
									<div class="input">
										...
										<label for="giftcard" class="input__label">Gift card
											number <span class="optional">(optional)</span>
										</label> <input id="giftcard" type="text" class="input__input" />
										<div class="input__error">Please enter a valid gift card
											number.</div>
									</div>
								</div>
								<div class="f30">
				...
				<div class="page page--4">
					...
					<p class="microcopy">Please review and make sure your order is
						correct.</p>
					...
					<div class="f">
						<div class="f70">
							<div class="input">
								<svg class="input__icon">
									<use xlink:href="#icon-info"></use></svg>
								<label for="couponcode" class="input__label">Coupon code
									<span class="optional">(optional)</span>
								</label> <input id="couponcode" type="text" class="input__input"
									data-mask=".{5,}" />
								<div class="input__error">Please enter a valid coupon
									code.</div>
							</div>
						</div>
						<div class="f30">
